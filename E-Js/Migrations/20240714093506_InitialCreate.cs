    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderProductDetailsId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOrders", x => x.OrderProductDetailsId);
                    table.ForeignKey(
                        name: "FK_ProductOrders_OrderProductDetails_OrderProductDetailsId",
                        column: x => x.OrderProductDetailsId,
                        principalTable: "OrderProductDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
